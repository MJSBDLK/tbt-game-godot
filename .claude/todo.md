...
- [ ] Move usage isn't resetting between battles - it should reset after every battle.
- [ ] The level next to the enemies' health bars on the map displays 1, not their real level.
