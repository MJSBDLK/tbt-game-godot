...
- [ ] When a terrain is impassable for the default unit type, it's confusing that the terrain preview panel reads the impedence as "1" - while technically correct, it looks like that terrain is walkable by all units. Please recommend multiple solutions for this and let me know which you believe would be the best UX.
