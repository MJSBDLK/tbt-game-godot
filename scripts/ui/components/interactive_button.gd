...
## NOTE: a border-glow experiment (orthogonal_glow border_mode haloing the
## border like the text) lived here through several tuning rounds and was
## dropped 2026-07-16 — the borderless look won (RQD: "cleaner, if
## inconsistent"). Recover from git history at 513949e..51a5fad if Lawrence
## overrules.
