...
const KNOB_NAMES := [
	...
	"STAR_TAIL_TIP_ALPHA", "STAR_REST_ALPHA_MIN", "UNIT_CALL_TO_ACTION_SECONDS",
	"UNIT_CALL_TO_ACTION_PASSES", "UNIT_CALL_TO_ACTION_STAGGER", "UNIT_CALL_TO_ACTION_REST_SECONDS",
]
